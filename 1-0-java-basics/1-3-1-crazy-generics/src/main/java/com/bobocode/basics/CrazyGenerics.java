...
public class CrazyGenerics {
    ...
    static class CollectionUtil {
         ...
         */
        public static<T extends BaseEntity> boolean isValidCollection(Collection<? extends BaseEntity> entities,
         ...
         */
        public static<T extends BaseEntity > boolean hasDuplicates(Collection<BaseEntity> entities, BaseEntity targetEntity) {
            return entities.stream()
         ...
         */
            public static <T extends BaseEntity> Optional <T> findMax(Iterable<T> elements,Comparator<? super BaseEntity> comparator) {// todo: create a method and implement its logic manually without using util method from JDK
         ...
         */
        public static <T extends BaseEntity> T findMostRecentlyCreatedEntity(Collection<T> entities) {// todo: create a method according to JavaDoc and implement it using previous method
